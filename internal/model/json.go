...
// raw JSON object and re-encode it verbatim, so a fetch → dump round trip
...
// UnmarshalJSON decodes a route and retains all unmodelled fields.
...
// UnmarshalJSON decodes a service and retains all unmodelled fields.
